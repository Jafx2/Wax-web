...
function OAuthDivider() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '24px 0', color: 'var(--muted)', fontSize: 12 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
        {providers.map(({ id, label, Icon }) => (
          <button
            ...
            onMouseEnter={e => { if (!loading) e.currentTarget.style.borderColor = '#333' }}
